<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="pseudo" type="text" class="mt-1 block w-full" wire:model="state.pseudo" required
                autocomplete="pseudo" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-textarea id="bio" class="mt-1 block w-full" wire:model.defer="state.bio" autocomplete="bio" />
