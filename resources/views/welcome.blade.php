    ...
    <nav class="bg-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <img src="{{ asset('images/logo.png') }}" alt="Logo" class="h-12 w-auto">                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition duration-300">Inscription</a>
                    @endauth
                </div>
            </div>
        </div>
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        ...
                        <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            Rejoignez notre communauté vibrante et connectez-vous avec des personnes partageant vos intérêts.
                        </p>
                        @guest
