    ...
    <div class="py-12 bg-gray-50">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8 flex justify-between items-center">
                <h3 class="text-lg text-gray-700 font-medium">Partagez vos pensées</h3>
                <a href="{{ route('posts.create') }}"
                    class="bg-blue-600 hover:bg-blue-700 text-green px-4 py-2 rounded-lg transition duration-200 flex items-center">
